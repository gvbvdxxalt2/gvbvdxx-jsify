  ...
  try {
    ...
    window.JSIfy = {
      ...
      setStageSize: function (width, height) {
        ...
        penSprite.rotateOffsetX = penSprite.width / 2;
        penSprite.rotateOffsetY = penSprite.height / 2;
        window.JSIfy.stageWidth = width;
        window.JSIfy.stageHeight = height;
        window.JSIfy.upscaleStage(window.JSIfy.stageScale);
      },
      ...
      ScratchSprite: class ScratchSprite {
        ...
        xToLeft(x, width) {
          return x - window.JSIfy.stageWidth / -2 + width / -2;
        }
        yToTop(y, height) {
          return y * -1 - window.JSIfy.stageHeight / -2 + height / -2;
        }
      ...
      upscaleStage: function (scale) {
        var VirtualWidth = window.JSIfy.stageWidth;
        var VirtualHeight = window.JSIfy.stageHeight;
      ...
      renderStage: function () {
        try {
          ...
          window.JSIfy.pixiPenSprite.width = window.JSIfy.stageWidth;
          window.JSIfy.pixiPenSprite.height = window.JSIfy.stageHeight;
          var allSprites = [];
          for (var sprite of this.sprites) {
